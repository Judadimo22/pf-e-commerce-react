...
export const Details = () => {
  ...
  console.log("productDetails", productDetails.tallas);
  let sizes = productDetails.tallas;
  console.log(sizes);
  const { id } = useParams();

  const { name, trademark, description, image, price, tallas, review, stock } =
    productDetails;
              ...
              <Chakra.Flex>
                ...
                >
                  {selectedSize === ""
                    ...
                    : productDetails.tallas.find(
                        (t) => t.talla === selectedSize
                      ).stock + " Disponibles"}
                </Chakra.Text>
              </Chakra.Flex>
            </Chakra.Box>
