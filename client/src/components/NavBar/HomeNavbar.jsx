...
import { Avatar, Box, Button, Flex, Icon, Menu, MenuButton, MenuItem, MenuList, Text, Image, Heading,IconButton } from "@chakra-ui/react";
        ...
        <>
            ...
            <Link to="/home">
                <Flex textAlign='center'>
                  <Image boxSize={{base:10,md:`70px`}} position='relative' left={{base:3, md:0}} borderRadius={`full`} src={logo}  alt={``}></Image>
                  <Heading textAlign="center" position='relative' left={{base:4, md:0}} top={{base:1.2, md:0}} fontWeight={1000} fontSize={{base:30,md:50}} alignItems='center' fontFamily="Alumni Sans, sans-serif">Casual Couture</Heading>
                </Flex>
            ...
            <Flex w="8%" justifyContent="space-between">
                ...
                <Menu cursor="pointer" >
                    <MenuButton >
                        <Avatar src={user?.picture} display={{base:'block' ,md:'block'}} position='relative' left={{base:5, md:0}}  size={{base:25,md:"md"}}/>
                    </MenuButton>
                <MenuList >
                ...
                <Box >
                <Link to='/cart'>
                <Icon display={{base:'none' ,md:'block'}}  bgColor="white" cursor="pointer" boxSize={12} borderRadius={50} p={2.5} justifyContent="center" alignItems="center"  as={AiOutlineShoppingCart}/> 
                </Link>
                </Box>
            </Flex>
