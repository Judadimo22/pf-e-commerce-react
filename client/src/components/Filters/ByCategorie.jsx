...
import {
  ChangefilterInputByCategorie, Filter, changeIndex, clearFilters,
...
const ByCategorie = () => {
  ...
  const selectIndex = useSelector(state=>state.filterIndex.byCategorie)
  ...
  const clearFilter = () => {
    ...
    dispatch(Filter());
    dispatch(changeIndex(["category",-1]))
  }
  return (
    <>
